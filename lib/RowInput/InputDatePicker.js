...
_this2.props.onDateChange(date);
}})));
...
_reactNative.Platform.OS==='android')){_context.next=16;break;}_context.prev=1;_context.next=4;return regeneratorRuntime.awrap(
...
code=_context.t0.code;message=_context.t0.message;case 16:case'end':return _context.stop();}}},null,this,[[1,12]]);}},{key:'render',value:function render()
