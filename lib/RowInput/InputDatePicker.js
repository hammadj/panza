...
this.props;var expanded=_props.expanded;var onToggleExpansion=_props.onToggleExpansion;var label=_props.label;var value=_props.value;var editable=_props.editable;var other=_objectWithoutProperties(_props,['expanded','onToggleExpansion','label','value','editable']);
...
}},{key:'toggleDatePicker',value:function toggleDatePicker(){var _ref,action,year,month,day,_code,_message;return regeneratorRuntime.async(function toggleDatePicker$(_context){while(1){switch(_context.prev=_context.next){case 0:if(!(
...
_code=_context.t0.code;_message=_context.t0.message;
console.warn('error opening date picker',_code,_message);case 17:case'end':return _context.stop();}}},null,this,[[1,12]]);}}]);return InputDatePicker;}(_react2.default.Component);InputDatePicker.displayName='InputDatePicker';InputDatePicker.propTypes={expanded:_react.PropTypes.bool.isRequired,/** function called to toggle the visibility of the date-picker. (iOS only) **/onToggleExpansion:_react.PropTypes.func.isRequired,/** the currently selected date to be displayed in collapsed row. **/value:_react.PropTypes.string,maxDate:_react.PropTypes.string,minDate:_react.PropTypes.string,label:_react.PropTypes.string,mode:_react.PropTypes.string,date:_react.PropTypes.object.isRequired,onDateChange:_react.PropTypes.func.isRequired,editable:_react.PropTypes.bool};InputDatePicker.defaultProps={editable:true};
