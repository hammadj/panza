...
_react2.default.createElement(_index.Divider,{inset:inset})));
...
this.props.label&&
_react2.default.createElement(_index.SectionHeader,{backgroundColor:'transparent'},this.props.label),

_react2.default.createElement(_index.Base,{backgroundColor:backgroundColor},
this.props.showTopBorder&&_react2.default.createElement(_index.Divider,{inset:topInset}),
children,
this.props.showBottomBorder&&_react2.default.createElement(_index.Divider,{inset:bottomInset}))));




}}]);return InputGroup;}(_react2.default.Component);InputGroup.displayName='InputGroup';InputGroup.propTypes={style:_react.PropTypes.object,inset:_react.PropTypes.number,showTopBorder:_react.PropTypes.bool,showBottomBorder:_react.PropTypes.bool,showBorder:_react.PropTypes.bool,topInset:_react.PropTypes.number,bottomInset:_react.PropTypes.number,label:_react.PropTypes.string,children:_react.PropTypes.node,backgroundColor:_react.PropTypes.string};InputGroup.defaultProps={bottomInset:0,topInset:0,showBottomBorder:true,showTopBorder:true,showBorder:true,inset:0};
