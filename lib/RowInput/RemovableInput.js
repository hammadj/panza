...
var RowActions=exports.RowActions=function RowActions(_ref){var children=_ref.children;var style=_ref.style;var other=_objectWithoutProperties(_ref,['children','style']);
...
var RowAction=exports.RowAction=function RowAction(_ref2){var children=_ref2.children;var props=_objectWithoutProperties(_ref2,['children']);
return(
_react2.default.createElement(_index.Base,_extends({
justify:'center',
...
function RemovableInput(props){_classCallCheck(this,RemovableInput);var _this=_possibleConstructorReturn(this,Object.getPrototypeOf(RemovableInput).call(this,
props));
_this.state={
...
_react2.default.createElement(_index.TextBase,{
...
_react2.default.createElement(_index.SecondaryText,null,'Cancel')),
...
_react2.default.createElement(_index.SecondaryText,{color:'white'},'Remove')));
...
this.props.editable?
_react2.default.createElement(_index.PrimaryTextInput,{
...
_react2.default.createElement(_index.PrimaryText,{numberOfLines:1},
this.props.value)))))));
...
}}]);return RemovableInput;}(_react2.default.Component);
...
//   }
// }
RemovableInput.displayName='RemovableInput';RemovableInput.propTypes={label:_react.PropTypes.string,autoFocus:_react.PropTypes.bool,removable:_react.PropTypes.bool,placeholder:_react.PropTypes.string,vertical:_react.PropTypes.bool,amountDecorator:_react.PropTypes.bool,condensed:_react.PropTypes.bool,onSelectLabel:_react.PropTypes.func.isRequired,onRemove:_react.PropTypes.func,autoFocus:_react.PropTypes.bool,onChangeText:_react.PropTypes.func.isRequired,value:_react.PropTypes.string,backgroundColor:_react.PropTypes.string,editable:_react.PropTypes.bool,labelWidth:_react.PropTypes.number,verticalHeight:_react.PropTypes.number};RemovableInput.defaultProps={removable:true,editable:true,backgroundColor:'white',textAlign:'right',keyboardType:'numeric',autoFocus:true,vertical:false,condensed:false,autoFocus:false,onRequestRemove:noop,verticalHeight:80,height:50};
