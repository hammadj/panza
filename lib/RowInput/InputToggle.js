...
InputToggle=function(_React$Component){_inherits(InputToggle,_React$Component);function InputToggle(){_classCallCheck(this,InputToggle);return _possibleConstructorReturn(this,Object.getPrototypeOf(InputToggle).apply(this,arguments));}_createClass(InputToggle,[{key:'render',value:function render()
...
this.props;var style=_props.style;var label=_props.label;var value=_props.value;var editable=_props.editable;var onValueChange=_props.onValueChange;var switchProps=_props.switchProps;var onTintColor=_props.onTintColor;var backgroundColor=_props.backgroundColor;var other=_objectWithoutProperties(_props,['style','label','value','editable','onValueChange','switchProps','onTintColor','backgroundColor']);var


panza=
this.context.panza;var _config=_extends({},_config3.default,

panza||{});var colors=_config.colors;
...
_react2.default.createElement(_index.PrimaryText,null,
label)),
