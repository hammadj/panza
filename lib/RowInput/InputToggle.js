...
this.props,style=_props.style,label=_props.label,value=_props.value,editable=_props.editable,onValueChange=_props.onValueChange,switchProps=_props.switchProps,onTintColor=_props.onTintColor,backgroundColor=_props.backgroundColor,other=_objectWithoutProperties(_props,['style','label','value','editable','onValueChange','switchProps','onTintColor','backgroundColor']);var
