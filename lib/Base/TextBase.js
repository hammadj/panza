...
panza),fontSizes=_config$panza.fontSizes,lineHeights=_config$panza.lineHeights,bold=_config$panza.bold,thin=_config$panza.thin,thick=_config$panza.thick,colors=_config$panza.colors,lineHeightAddition=_config$panza.lineHeightAddition,scale=_config$panza.scale;
