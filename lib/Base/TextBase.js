...
var TextBase = function TextBase(_ref, _ref2) {
  ...
  var thin = _config$panza.thin;
  var thick = _config$panza.thick;
  var colors = _config$panza.colors;
  var lineHeightAddition = _config$panza.lineHeightAddition;
  var scale = _config$panza.scale;


  var sx = [baseStyle, (0, _Base.margins)(props, scale), (0, _Base.paddings)(props, scale), size(fontSize, fontSizes, lineHeight, lineHeights, lineHeightAddition), propsToStyle(props, bold, thin, thick, colors), style];
