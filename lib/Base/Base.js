...
props||{},backgroundColor=_ref5.backgroundColor,borderColor=_ref5.borderColor;
...
this.props,style=_props.style,Component=_props.Component,_props$baseStyle=_props.baseStyle,baseStyle=_props$baseStyle===undefined?{}:_props$baseStyle,wrap=_props.wrap,underlayColor=_props.underlayColor,flex=_props.flex,row=_props.row,column=_props.column,align=_props.align,height=_props.height,justify=_props.justify,props=_objectWithoutProperties(_props,['style','Component','baseStyle','wrap','underlayColor','flex','row','column','align','height','justify']);var
...
}}]);return Base;}(_react2.default.Component);Base.propTypes={Component:_react.PropTypes.any,style:_react.PropTypes.any,baseStyle:_react.PropTypes.any,underlayColor:_react.PropTypes.string,m:_react.PropTypes.oneOf([0,1,2,3,4]),mt:_react.PropTypes.oneOf([0,1,2,3,4]),mr:_react.PropTypes.oneOf([0,1,2,3,4]),mb:_react.PropTypes.oneOf([0,1,2,3,4]),ml:_react.PropTypes.oneOf([0,1,2,3,4]),mx:_react.PropTypes.oneOf([0,1,2,3,4]),my:_react.PropTypes.oneOf([0,1,2,3,4]),p:_react.PropTypes.oneOf([0,1,2,3,4]),pt:_react.PropTypes.oneOf([0,1,2,3,4]),pr:_react.PropTypes.oneOf([0,1,2,3,4]),pb:_react.PropTypes.oneOf([0,1,2,3,4]),pl:_react.PropTypes.oneOf([0,1,2,3,4]),px:_react.PropTypes.oneOf([0,1,2,3,4]),py:_react.PropTypes.oneOf([0,1,2,3,4]),backgroundColor:_react.PropTypes.string,rounded:_react.PropTypes.oneOfType([_react.PropTypes.bool,_react.PropTypes.number]),borderColor:_react.PropTypes.string,flex:_react.PropTypes.number,wrap:_react.PropTypes.bool,column:_react.PropTypes.bool,row:_react.PropTypes.bool,align:_react.PropTypes.string,justify:_react.PropTypes.string,height:_react.PropTypes.string};Base.displayName='Base';Base.contextTypes={panza:_react.PropTypes.object};exports.default=
