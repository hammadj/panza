...
props||{};var backgroundColor=_ref5.backgroundColor;
...
Base=function(_React$Component){_inherits(Base,_React$Component);function Base(){_classCallCheck(this,Base);return _possibleConstructorReturn(this,Object.getPrototypeOf(Base).apply(this,arguments));}_createClass(Base,[{key:'render',value:function render()
...
this.props;var style=_props.style;var Component=_props.Component;var _props$baseStyle=_props.baseStyle;var baseStyle=_props$baseStyle===undefined?{}:_props$baseStyle;var wrap=_props.wrap;var underlayColor=_props.underlayColor;var flex=_props.flex;var row=_props.row;var column=_props.column;var auto=_props.auto;var align=_props.align;var justify=_props.justify;var props=_objectWithoutProperties(_props,['style','Component','baseStyle','wrap','underlayColor','flex','row','column','auto','align','justify']);var
...
panza);var scale=_config$panza.scale;var colors=_config$panza.colors;var borderRadius=_config$panza.borderRadius;
...
}}]);return Base;}(_react2.default.Component);Base.propTypes={/** Margin **/m:_react.PropTypes.oneOf([0,1,2,3,4]),/** Margin top **/mt:_react.PropTypes.oneOf([0,1,2,3,4]),/** Margin right **/mr:_react.PropTypes.oneOf([0,1,2,3,4]),/** Margin bottom **/mb:_react.PropTypes.oneOf([0,1,2,3,4]),/** Margin left **/ml:_react.PropTypes.oneOf([0,1,2,3,4]),/** Margin x-axis **/mx:_react.PropTypes.oneOf([0,1,2,3,4]),/** Margin y-asix **/my:_react.PropTypes.oneOf([0,1,2,3,4]),/** Padding **/p:_react.PropTypes.oneOf([0,1,2,3,4]),/** Padding top **/pt:_react.PropTypes.oneOf([0,1,2,3,4]),/** Padding right **/pr:_react.PropTypes.oneOf([0,1,2,3,4]),/** Padding bottom **/pb:_react.PropTypes.oneOf([0,1,2,3,4]),/** Padding left **/pl:_react.PropTypes.oneOf([0,1,2,3,4]),/** Padding x-axis **/px:_react.PropTypes.oneOf([0,1,2,3,4]),/** Padding y-axis **/py:_react.PropTypes.oneOf([0,1,2,3,4]),/** Background color **/backgroundColor:_react.PropTypes.string,/** Border radius **/rounded:_react.PropTypes.oneOfType([_react.PropTypes.bool,_react.PropTypes.number]),/** flex property **/flex:_react.PropTypes.number,/** flex-wrap property **/wrap:_react.PropTypes.bool,/** set flex-direction to column **/column:_react.PropTypes.bool,/** set flex-direction to row **/row:_react.PropTypes.bool,/** set align-items property **/align:_react.PropTypes.string,/** set justify-content property **/justify:_react.PropTypes.string};Base.displayName='Base';Base.contextTypes={panza:_react.PropTypes.object};exports.default=
