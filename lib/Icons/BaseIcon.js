...
var BaseIcon=function BaseIcon(props){var

name=


props.name,iconSize=props.iconSize,other=_objectWithoutProperties(props,['name','iconSize']);

console.log('ICON SIZE',iconSize);
return(
_react2.default.createElement(_Base.TextBase,_extends({
name:name,
iconSize:iconSize,
